...
<body class="bg-gray-100 h-screen">
    ...
    <!-- Main Content -->
    <div class="container mx-auto mt-4 flex h-full">
        <!-- Content -->
        <main class="w-full bg-white py-4 px-4 overflow-auto">
    ...
    <footer class="bg-gray-200 text-center py-4 mt-4">
        <p class="text-sm text-gray-600">© 2024 Admin Panel. All rights reserved.</p>
    </footer>
</body>
